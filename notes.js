...
applyViewerTheme(sender);document.querySelector('.back-to-side').href=`${sender}.html`;document.getElementById('note-heading').textContent=`Send ${recipient} a tiny note`;
